package com.digitalinnovationone.collectionscourse.streams;
...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        //Retorna contagem de elementos da Stream
        ...
        //Retorna só os que tem a letra 'r' no nome
        ...
        System.out.println("Tem algum elemento com a letra a minusculo no nome?: " + estudantes.stream().anyMatch((elemento -> elemento.contains("a"))));

        //Retorna true, se nenhum elemento possui a letra 'a' minusculo no nome
